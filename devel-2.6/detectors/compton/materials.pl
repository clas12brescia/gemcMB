...
sub define_bdx_materials
{
    ...
    %mat = init_mat();
    $mat{"name"}          = "NaI_Tl";
    $mat{"description"}   = "Standard crystal NaI(Tl) 3.67 g/cm3";
    $mat{"density"}       = "3.67";
    $mat{"ncomponents"}   = "2";
    $mat{"components"}    = "G4_SODIUM_IODIDE 0.999 G4_Tl 0.001";
    print_mat(\%configuration, \%mat);
    ...
    %mat = init_mat();
    $mat{"name"}          = "Silicone";
    $mat{"description"}   = "Silicone Polysiloxanes";
    $mat{"density"}       = "2.33";
    $mat{"ncomponents"}   = "4";
    $mat{"components"}    = "C 2 O 1 Si 1 H 6";
    print_mat(\%configuration, \%mat);
