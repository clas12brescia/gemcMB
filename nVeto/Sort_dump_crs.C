...
void Sort_dump_crs(string inputname="Sci1cm_p33,6MeV", int veto_threshold =100){
  ...
  string outname("/mnt/project_mnt/jlab12/fiber7_fs/gosta/Output/Sort_" + inputname +"_thr" + Form ("%d",veto_threshold)+ "keV.root");
	...
	TGraph tempGraph = TGraph("flux_dump.dat");
  ...
  fluxClass * myFl= new fluxClass(flux);
    ...
    TH1D *Gen_Ek_binT= new TH1D("Gen_Ek_binT","Gen_Ek_binT",fluxBinNumber-1,fluxBinLeftEdge);
		Gen_Ek_binT->GetXaxis()->SetTitle("Kinetic Energy [GeV]");
	  Gen_Ek_binT->GetYaxis()->SetTitle("Counts");  
          
    TH1D *Gen_Ek_crs_binT= new TH1D("Gen_Ek_crs_binT","Gen_Ek_crs_binT",fluxBinNumber-1,fluxBinLeftEdge);
		Gen_Ek_crs_binT->GetXaxis()->SetTitle("Kinetic Energy [GeV]");
	  Gen_Ek_crs_binT->GetYaxis()->SetTitle("Counts");  
    
    TH1D *NFlux= new TH1D("NFlux","NFlux",fluxBinNumber-1,fluxBinLeftEdge);
    ...
    TH2F *crs_jentry_Ek_g_single= new TH2F("crs_jentry_Ek_g_single","crs_jentry_Ek_g_single",161,0,160,10000,0,10000);
		crs_jentry_Ek_g_single->GetXaxis()->SetTitle("# single gamma");
 	  crs_jentry_Ek_g_single->GetYaxis()->SetTitle("Energy[keV]");  	
	
	  TH2F *crs_jentry_Ek_g_outc= new TH2F("crs_jentry_Ek_g_outc","crs_jentry_Ek_g_outc",161,0,160,10000,0,10000);
		crs_jentry_Ek_g_outc->GetXaxis()->SetTitle("# out coinc gamma");
 	  crs_jentry_Ek_g_outc->GetYaxis()->SetTitle("Energy[keV]");
      
    TH2F *crs_jentry_Ek_n_single= new TH2F("crs_jentry_Ek_n_single","crs_jentry_Ek_n_single",161,0,160,1000,0,1000);
		crs_jentry_Ek_n_single->GetXaxis()->SetTitle("# single n");
 	  crs_jentry_Ek_n_single->GetYaxis()->SetTitle("Energy[MeV]");  	
	
	  TH2F *crs_jentry_Ek_n_outc= new TH2F("crs_jentry_Ek_n_outc","crs_jentry_Ek_n_outc",161,0,160,1000,0,1000);
		crs_jentry_Ek_n_outc->GetXaxis()->SetTitle("# out coinc n");
 	  crs_jentry_Ek_n_outc->GetYaxis()->SetTitle("Energy[MeV]");
       
      
    TH2F *crs_jentry_vy_g_single_vz= new TH2F("crs_jentry_vy_g_single_vz","crs_jentry_vy_g_single_vz",161,0,160,601,-600,600);
		crs_jentry_vy_g_single_vz->GetXaxis()->SetTitle("# single gamma");
 	  crs_jentry_vy_g_single_vz->GetYaxis()->SetTitle("vy");  	
	
	  TH2F *crs_jentry_vy_g_outc_vz= new TH2F("crs_jentry_vy_g_outc_vz","crs_jentry_vy_g_outc_vz",161,0,160,601,-600,600);
		crs_jentry_vy_g_outc_vz->GetXaxis()->SetTitle("# out coinc gamma");
 	  crs_jentry_vy_g_outc_vz->GetYaxis()->SetTitle("vy");
      
    TH2F *crs_jentry_vy_n_single_vz= new TH2F("crs_jentry_vy_n_single_vz","crs_jentry_vy_n_single_vz",161,0,160,601,-600,600);
		crs_jentry_vy_n_single_vz->GetXaxis()->SetTitle("# single neutron");
 	  crs_jentry_vy_n_single_vz->GetYaxis()->SetTitle("vy");  
	
	  TH2F *crs_jentry_vy_n_outc_vz= new TH2F("crs_jentry_vy_n_outc_vz","crs_jentry_vy_n_outc_vz",161,0,160,601,-600,600);
		crs_jentry_vy_n_outc_vz->GetXaxis()->SetTitle("# out coinc neutron");
 	  crs_jentry_vy_n_outc_vz->GetYaxis()->SetTitle("vy");
      
    TH2F *crs_jentry_vy_g_single_vx= new TH2F("crs_jentry_vy_g_single_vx","crs_jentry_vy_g_single_vx",161,0,160,601,-600,600);
		crs_jentry_vy_g_single_vx->GetXaxis()->SetTitle("# single gamma");
 	  crs_jentry_vy_g_single_vx->GetYaxis()->SetTitle("vy");  	
	
	  TH2F *crs_jentry_vy_g_outc_vx= new TH2F("crs_jentry_vy_g_outc_vx","crs_jentry_vy_g_outc_vx",161,0,160,601,-600,600);
		crs_jentry_vy_g_outc_vx->GetXaxis()->SetTitle("# out coinc gamma");
 	  crs_jentry_vy_g_outc_vx->GetYaxis()->SetTitle("vy");
      
    TH2F *crs_jentry_vy_n_single_vx= new TH2F("crs_jentry_vy_n_single_vx","crs_jentry_vy_n_single_vx",161,0,160,601,-600,600);
		crs_jentry_vy_n_single_vx->GetXaxis()->SetTitle("# single neutron");
 	  crs_jentry_vy_n_single_vx->GetYaxis()->SetTitle("vy");  
	
	  TH2F *crs_jentry_vy_n_outc_vx= new TH2F("crs_jentry_vy_n_outc_vx","crs_jentry_vy_n_outc_vx",161,0,160,601,-600,600);
		crs_jentry_vy_n_outc_vz->GetXaxis()->SetTitle("# out coinc neutron");
 	  crs_jentry_vy_n_outc_vz->GetYaxis()->SetTitle("vy");
    ...
    TH2F *crs_jentry_fluxid_n_single= new TH2F("crs_jentry_fluxid_n_single","crs_jentry_fluxid_n_single",161,0,160,81,0,80);
  ...
  const double coinc_value=2.5; // in micorseconds
    ...
    double mom_sec=0;
    double Ek_sec=0; //secondaries
    double Etot_sec=0;


		Gen_Ek->Fill(Ek/1000); // in GeV
    Gen_Ek_binT->Fill(Ek/1000); // in GeV
      ...
      if (myCrs->totEdep->at(ihit)*1000> crs_threshold && myCrs->totEdep->at(ihit)*1000<crs_maxEdep){  // Look only at Edep between 10-200keV (neutrino Edep)
        ...
        if (DeltaT_signed==1E8){
          ...
          if(myCrs->pid->at(ihit)==22){  //gammas
            crs_jentry_Ek_g_single-> Fill (single, myCrs->trackE->at(ihit)*1000); //energy and vertex in cm
            crs_jentry_vy_g_single_vz-> Fill (single,myCrs->vy->at(ihit)/10, myCrs->vz->at(ihit)/10);
            crs_jentry_vy_g_single_vx-> Fill (single,myCrs->vy->at(ihit)/10, myCrs->vx->at(ihit)/10);
            for (int khit=0; khit < flux_nhit; khit++){
              if(myCrs->tid->at(ihit)==myFl->tid->at(khit))  crs_jentry_fluxid_g_single->Fill(single,myFl->id->at(khit),myFl->avg_t->at(khit));
            }
          }
          if(myCrs->pid->at(ihit)==2112){ // neutrons
          mom_sec = sqrt(pow(myCrs->px->at(ihit),2) + pow(myCrs->py->at(ihit),2) + pow(myCrs->pz->at(ihit),2));  
          Etot_sec = myCrs->trackE->at(ihit);
          Ek_sec =  Etot_sec - sqrt(pow(Etot_sec,2) - pow(mom_sec,2));
            crs_jentry_Ek_n_single-> Fill (single, Ek_sec);
            crs_jentry_vy_n_single_vz-> Fill (single,myCrs->vy->at(ihit)/10, myCrs->vz->at(ihit)/10);
            crs_jentry_vy_n_single_vx-> Fill (single,myCrs->vy->at(ihit)/10, myCrs->vx->at(ihit)/10);
            for (int khit=0; khit < flux_nhit; khit++){
              if(myCrs->tid->at(ihit)==myFl->tid->at(khit)) crs_jentry_fluxid_n_single->Fill(single,myFl->id->at(khit),myFl->avg_t->at(khit));
            }
          }
        }
        if ((DeltaT_signed >= coinc_value || DeltaT_signed <= -coinc_value) && DeltaT_signed!=1E8 ){
          ...
          if(myCrs->pid->at(ihit)==22){
            crs_jentry_Ek_g_outc-> Fill (out_coinc, myCrs->trackE->at(ihit)*1000);
            crs_jentry_vy_g_outc_vz-> Fill (out_coinc,myCrs->vy->at(ihit)/10, myCrs->vz->at(ihit)/10);
            crs_jentry_vy_g_outc_vx-> Fill (out_coinc,myCrs->vy->at(ihit)/10, myCrs->vx->at(ihit)/10 );
            for (int khit=0; khit < flux_nhit; khit++){
              if(myCrs->tid->at(ihit)==myFl->tid->at(khit))  crs_jentry_fluxid_g_outc->Fill(out_coinc,myFl->id->at(khit),myFl->avg_t->at(khit));
            }
          }
          if(myCrs->pid->at(ihit)==2112){
            ...
            Etot_sec = myCrs->trackE->at(ihit);
            Ek_sec =  Etot_sec - sqrt(pow(Etot_sec,2) - pow(mom_sec,2));
            crs_jentry_Ek_n_outc-> Fill (out_coinc, Ek_sec);
            crs_jentry_vy_n_outc_vz-> Fill (out_coinc,myCrs->vy->at(ihit)/10, myCrs->vz->at(ihit)/10);
            crs_jentry_vy_n_outc_vx-> Fill (out_coinc,myCrs->vy->at(ihit)/10, myCrs->vx->at(ihit)/10 );
            for (int khit=0; khit < flux_nhit; khit++){
              if(myCrs->tid->at(ihit)==myFl->tid->at(khit))  crs_jentry_fluxid_n_outc->Fill(out_coinc,myFl->id->at(khit),myFl->avg_t->at(khit));
            }
          }
        } 
...
// flux ----------------------------------------------------------------    
    ...
    for (int i=1; i<nhit_crs->GetNbinsX(); i++){            // number of total hit in the crs 
     ...
     ofstream fout("Results_dump_0_465MeV_0.1Pb+6v+wup+Pbup.txt",ios::app);
     fout<<inputname<<endl;
...
*/
    ...
    Gen_Ek_crs_binT->Write(0,TObject::kOverwrite);
    ...
    crs_jentry_Ek_g_single->SetOption("text");
    crs_jentry_Ek_g_outc->SetOption("text");
    crs_jentry_Ek_n_single->SetOption("text");
    crs_jentry_Ek_n_outc->SetOption("text");
    crs_jentry_Ek_g_single->Write(0,TObject::kOverwrite);
    crs_jentry_Ek_g_outc->Write(0,TObject::kOverwrite);
    crs_jentry_Ek_n_single->Write(0,TObject::kOverwrite);
    crs_jentry_Ek_n_outc->Write(0,TObject::kOverwrite);
    
    crs_jentry_vy_g_single_vx->Write(0,TObject::kOverwrite);
    crs_jentry_vy_g_outc_vx->Write(0,TObject::kOverwrite);
    crs_jentry_vy_n_single_vx->Write(0,TObject::kOverwrite);
    crs_jentry_vy_n_outc_vx->Write(0,TObject::kOverwrite);
    crs_jentry_vy_g_single_vz->Write(0,TObject::kOverwrite);
    crs_jentry_vy_g_outc_vz->Write(0,TObject::kOverwrite);
    crs_jentry_vy_n_single_vz->Write(0,TObject::kOverwrite);
    crs_jentry_vy_n_outc_vz->Write(0,TObject::kOverwrite);
