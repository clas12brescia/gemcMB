...
// Fri Apr 15 08:02:51 2022 by ROOT version 6.12/06
// from TTree det/det bank ID
// found on file: out_prova.root
//////////////////////////////////////////////////////////
...
#ifdef detClass_cxx
detClass::detClass(TTree *tree) : fChain(0) 
{
...
Int_t detClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t detClass::LoadTree(Long64_t entry)
{
...
void detClass::Show(Long64_t entry)
{
...
Int_t detClass::Cut(Long64_t entry)
{
